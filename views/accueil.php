  ...
  <aside class="filtres w-form">
    <form id="email-form" name="email-form" data-name="Email Form" method="get" class="form"
      ...
      <fieldset>
        ...
        <label class="w-radio">
          <input type="radio" id="radio-alternance" name="Type" class="w-form-formradioinput w-radio-input" value="Alternance">
      ...
      <fieldset>
        ...
        <label class="w-checkbox">
          <input type="checkbox" id="checkbox-btp" name="checkbox-btp" class="w-form-formcheckboxinput w-checkbox-input">
          <span class="w-form-label">BTP</span>
        </label>

        <label class="w-checkbox">
          <input type="checkbox" id="checkbox-s3e" name="checkbox-s3e" class="w-form-formcheckboxinput w-checkbox-input">
          <span class="w-form-label">S3E</span>
        </label>

        <label class="w-checkbox">
          <input type="checkbox" id="checkbox-informatique" name="checkbox-informatique" class="w-form-formcheckboxinput w-checkbox-input">
          <span class="w-form-label">Informatique</span>
        </label>

        <label class="w-checkbox">
          <input type="checkbox" id="checkbox-generaliste" name="checkbox-generaliste" class="w-form-formcheckboxinput w-checkbox-input">
